...
#ifndef FITNESSTRACKERWATCH_SWIFT_H
#define FITNESSTRACKERWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FitnessTrackerWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19FitnessTrackerWatch17ExtensionDelegate")
@interface ExtensionDelegate : NSObject <WKApplicationDelegate>
- (void)handleWorkoutConfiguration:(HKWorkoutConfiguration * _Nonnull)workoutConfiguration;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC19FitnessTrackerWatch19WatchWorkoutManager")
...
@class HKSampleType;
@interface WatchWorkoutManager (SWIFT_EXTENSION(FitnessTrackerWatch)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WatchWorkoutManager (SWIFT_EXTENSION(FitnessTrackerWatch)) <HKWorkoutSessionDelegate>
...
@class WCSession;
@class NSString;
@interface WatchWorkoutManager (SWIFT_EXTENSION(FitnessTrackerWatch)) <WCSessionDelegate>
